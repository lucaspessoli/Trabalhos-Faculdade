...
public class Ex1 {
    ...
    public static void main(String[] args) {
        ...
        Paciente paciente1 = new Paciente("Maria Joaquina", "029.495.192-59",27,77,true);
        Paciente paciente2 = new Paciente("Professora helena", "013.425.112-92",32,11,true);
        Paciente paciente3 = new Paciente("Cirilo Neves", "918.492.915-23",34,34,true);
        Paciente paciente4 = new Paciente("Ruan", "912.321.601-62",11,24,false);
        Paciente paciente5 = new Paciente("Marcao", "029.213.012-52",14,66,false);
        Paciente paciente6 = new Paciente("Dez", "291.421.426-52",22,55,false);
